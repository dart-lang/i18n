...
void main() {
  ...
  test('guardBracketInHtml', () {
    ...
    expect(
      Bidi.guardBracketInHtml(strWithRtl),
      equals('asc \u05d0 <span dir=rtl>(\u05d0\u05d0\u05d0)</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithRtl, true),
      equals('asc \u05d0 <span dir=rtl>(\u05d0\u05d0\u05d0)</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithRtl, false),
      equals('asc \u05d0 <span dir=ltr>(\u05d0\u05d0\u05d0)</span>'),
    );

    var strWithRtl2 = '\u05d0 a (asc:))';
    expect(
      Bidi.guardBracketInHtml(strWithRtl2),
      equals('\u05d0 a <span dir=rtl>(asc:))</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithRtl2, true),
      equals('\u05d0 a <span dir=rtl>(asc:))</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithRtl2, false),
      equals('\u05d0 a <span dir=ltr>(asc:))</span>'),
    );

    var strWithoutRtl = 'a (asc) {{123}}';
    expect(
      Bidi.guardBracketInHtml(strWithoutRtl),
      equals('a <span dir=ltr>(asc)</span> <span dir=ltr>{{123}}</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithoutRtl, true),
      equals('a <span dir=rtl>(asc)</span> <span dir=rtl>{{123}}</span>'),
    );
    expect(
      Bidi.guardBracketInHtml(strWithoutRtl, false),
      equals('a <span dir=ltr>(asc)</span> <span dir=ltr>{{123}}</span>'),
    );
  });
  ...
  test('guardBracketInText', () {
    ...
    var strWithRtl2 = '\u05d0 a (asc:))';
    expect(
      Bidi.guardBracketInText(strWithRtl2),
      equals('\u05d0 a \u200f(asc:))\u200f'),
    );
    expect(
  ...
  test('estimateDirectionOfText', () {
    expect(
      Bidi.estimateDirectionOfText('', isHtml: false).value,
    ...
    expect(
      Bidi.estimateDirectionOfText('-17.0%', isHtml: false).value,
      equals(TextDirection.LTR.value),
    );
    expect(
      Bidi.estimateDirectionOfText('http://foo/bar/', isHtml: false).value,
      equals(TextDirection.LTR.value),
    );
    expect(
    ...
    expect(
      Bidi.estimateDirectionOfText('\u05d0', isHtml: false).value,
  ...
  test('detectRtlDirectionality', () {
    ...
    for (var i = 0; i < bidiText.length; i++) {
      var isRtlDir = Bidi.detectRtlDirectionality(
        bidiText[i].text,
