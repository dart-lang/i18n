...
@KeepSymbol('ICU4XDecomposingNormalizer_create_nfd')
...
@KeepSymbol('ICU4XDecomposingNormalizer_create_nfkd')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XDecomposingNormalizer_normalize')
@ffi.Native<
...
@KeepSymbol('ICU4XDecomposingNormalizer_is_normalized')
@ffi.Native<
        ffi.Bool Function(
