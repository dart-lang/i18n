...
@KeepSymbol('ICU4XDataProvider_destroy')
...
@KeepSymbol('ICU4XDataProvider_create_compiled')
...
@KeepSymbol('ICU4XDataProvider_create_from_byte_slice')
...
@KeepSymbol('ICU4XDataProvider_fork_by_locale')
@ffi.Native<
        _ResultVoidInt32 Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XDataProvider_enable_locale_fallback')
...
@KeepSymbol('ICU4XDataProvider_enable_locale_fallback_with')
@ffi.Native<
        _ResultVoidInt32 Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(
