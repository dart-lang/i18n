...
@KeepSymbol('ICU4XIsoDateTime_destroy')
...
@KeepSymbol('ICU4XIsoDateTime_create')
@ffi.Native<
...
@KeepSymbol('ICU4XIsoDateTime_crate_from_date_and_time')
@ffi.Native<
...
@KeepSymbol('ICU4XIsoDateTime_local_unix_epoch')
...
@KeepSymbol('ICU4XIsoDateTime_date')
...
@KeepSymbol('ICU4XIsoDateTime_time')
@ffi.Native<ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XIsoDateTime_to_any')
@ffi.Native<ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XIsoDateTime_to_calendar')
@ffi.Native<
        ffi.Pointer<ffi.Opaque> Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XIsoDateTime_hour')
...
@KeepSymbol('ICU4XIsoDateTime_day_of_year')
...
@KeepSymbol('ICU4XIsoDateTime_week_of_year')
@ffi.Native<
...
@KeepSymbol('ICU4XIsoDateTime_months_in_year')
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XIsoDateTime_days_in_month')
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XIsoDateTime_days_in_year')
@ffi.Native<ffi.Uint16 Function(ffi.Pointer<ffi.Opaque>)>(
