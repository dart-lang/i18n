...
@KeepSymbol('ICU4XCodePointMapData16_destroy')
...
@KeepSymbol('ICU4XCodePointMapData16_get')
...
@KeepSymbol('ICU4XCodePointMapData16_iter_ranges_for_value')
@ffi.Native<
...
@KeepSymbol('ICU4XCodePointMapData16_iter_ranges_for_value_complemented')
@ffi.Native<
        ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, ffi.Uint16)>(
    isLeaf: true,
...
@KeepSymbol('ICU4XCodePointMapData16_get_set_for_value')
@ffi.Native<
        ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, ffi.Uint16)>(
...
@KeepSymbol('ICU4XCodePointMapData16_load_script')
