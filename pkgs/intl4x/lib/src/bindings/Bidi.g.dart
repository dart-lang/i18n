...
@KeepSymbol('ICU4XBidi_for_text_valid_utf8')
@ffi.Native<
...
@KeepSymbol('ICU4XBidi_reorder_visual')
@ffi.Native<
    ffi.Pointer<ffi.Opaque> Function(
        ffi.Pointer<ffi.Opaque>,
        ffi.Pointer<ffi.Uint8>,
...
@KeepSymbol('ICU4XBidi_level_is_rtl')
