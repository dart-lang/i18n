...
@KeepSymbol('ICU4XListFormatter_destroy')
...
@KeepSymbol('ICU4XListFormatter_create_and_with_length')
@ffi.Native<
...
@KeepSymbol('ICU4XListFormatter_create_or_with_length')
@ffi.Native<
        _ResultOpaqueInt32 Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Int32)>(
...
@KeepSymbol('ICU4XListFormatter_create_unit_with_length')
@ffi.Native<
        _ResultOpaqueInt32 Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Int32)>(
...
@KeepSymbol('ICU4XListFormatter_format_utf16')
@ffi.Native<
