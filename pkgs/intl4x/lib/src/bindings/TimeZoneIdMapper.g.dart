...
@KeepSymbol('ICU4XTimeZoneIdMapper_destroy')
...
@KeepSymbol('ICU4XTimeZoneIdMapper_create')
...
@KeepSymbol('ICU4XTimeZoneIdMapper_iana_to_bcp47')
@ffi.Native<
...
@KeepSymbol('ICU4XTimeZoneIdMapper_normalize_iana')
@ffi.Native<
        _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
            ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XTimeZoneIdMapper_find_canonical_iana_from_bcp47')
@ffi.Native<
        _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
            ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
