...
@KeepSymbol('ICU4XTimeFormatter_destroy')
...
@KeepSymbol('ICU4XTimeFormatter_create_with_length')
@ffi.Native<
...
@KeepSymbol('ICU4XTimeFormatter_format_time')
@ffi.Native<
...
@KeepSymbol('ICU4XTimeFormatter_format_datetime')
@ffi.Native<
        _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XTimeFormatter_format_iso_datetime')
@ffi.Native<
        _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(
