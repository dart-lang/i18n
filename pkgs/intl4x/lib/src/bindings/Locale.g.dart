...
@KeepSymbol('ICU4XLocale_destroy')
...
@KeepSymbol('ICU4XLocale_create_und')
...
@KeepSymbol('ICU4XLocale_basename')
@ffi.Native<
...
@KeepSymbol('ICU4XLocale_get_unicode_extension')
@ffi.Native<
        _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
...
@KeepSymbol('ICU4XLocale_language')
@ffi.Native<
    _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
...
@KeepSymbol('ICU4XLocale_set_language')
@ffi.Native<
...
@KeepSymbol('ICU4XLocale_set_region')
@ffi.Native<
    _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>,
...
@KeepSymbol('ICU4XLocale_set_script')
@ffi.Native<
    _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>,
...
@KeepSymbol('ICU4XLocale_canonicalize')
@ffi.Native<
...
@KeepSymbol('ICU4XLocale_to_string')
@ffi.Native<
    _ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>,
...
@KeepSymbol('ICU4XLocale_strict_cmp_')
@ffi.Native<
...
@KeepSymbol('ICU4XLocale_total_cmp_')
@ffi.Native<
