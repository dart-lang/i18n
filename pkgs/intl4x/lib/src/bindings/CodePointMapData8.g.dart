...
@KeepSymbol('ICU4XCodePointMapData8_destroy')
...
@KeepSymbol('ICU4XCodePointMapData8_get')
...
@KeepSymbol('ICU4XCodePointMapData8_general_category_to_mask')
...
@KeepSymbol('ICU4XCodePointMapData8_iter_ranges_for_value')
@ffi.Native<
...
@KeepSymbol('ICU4XCodePointMapData8_iter_ranges_for_value_complemented')
@ffi.Native<
        ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, ffi.Uint8)>(
    isLeaf: true,
...
@KeepSymbol('ICU4XCodePointMapData8_iter_ranges_for_mask')
@ffi.Native<
...
@KeepSymbol('ICU4XCodePointMapData8_get_set_for_value')
@ffi.Native<
        ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, ffi.Uint8)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_general_category')
...
@KeepSymbol('ICU4XCodePointMapData8_load_bidi_class')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_east_asian_width')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_hangul_syllable_type')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_indic_syllabic_category')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_line_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_try_grapheme_cluster_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_word_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_sentence_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@KeepSymbol('ICU4XCodePointMapData8_load_joining_type')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
