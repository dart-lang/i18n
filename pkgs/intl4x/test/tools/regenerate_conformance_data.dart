...
(\n    $precision,\n    $length,\n    $alignment,\n    $yearStyle,\n  )''';
  ...
  try {
    File(
      'test/datetime_format_conformance_data/ymdet.dart',
    ).writeAsStringSync(formattedCode);
    print(
      'Successfully generated map content and wrote to test/datetime_format_conformance_data/ymdet.dart',
    );
  } catch (e) {
    print(
      'Error writing to file test/datetime_format_conformance_data/ymdet.dart: $e',
    );
  }
}
