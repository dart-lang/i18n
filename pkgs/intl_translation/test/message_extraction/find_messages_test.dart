...
String message(String string) =>
    ...
    test('fails with message on prefixed expression in interpolation', () {
      ...
      expect(
        ...
        anyElement(
          contains(
            'Only simple identifiers and Intl.plural/gender/select '
    ...
    test(
      'fails on call with name referencing variable name inside a function',
      () {
        final messageExtraction = MessageExtraction();
        findMessages(
          '''
      class MessageTest {
        ...
        expect(
          ...
          anyElement(
            contains(
              'The \'name\' argument for Intl.message '
